...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-lock"></i> Group Permissions</h3>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-lock"></i> Action Permissions</h3>
                </div>

                <div class="table-responsive">

                    <table class="table table-bordered table-hover table-striped1 tablesorter1">
                        <thead>
                            <tr>
                                <?php
                                ...
                                foreach($roles as $role)
                                {
                                    $headers[] = ucfirst($role[$role_model_name][$role_display_field]);
                                    $column_count++;
                                }
...
//    	    debug($plugin_ctrler_infos);
                             ...
                             echo '<tr class="title"><td colspan="' . $column_count . '"><strong>' . __d('acl', 'Plugin') . ' ' . $plugin_name . '</strong></td></tr>';
