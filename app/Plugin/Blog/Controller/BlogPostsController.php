 ...
 */
	public function admin_view($id = null) {
      ...
      $this->set('page_title','<i class="fa fa-edit"></i> Blog');
      $this->set('page_subtitle','view post');
	}
	...
	public function admin_add() {
		if ($this->request->is('post')) {
			...
			if ($this->BlogPost->save($this->request->data)) {
				$this->Session->setFlash('The blog post has been saved','flash-success');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The blog post could not be saved. Please, try again.','flash-error');
			}
		}
		$blogPostCategories = $this->BlogPost->BlogPostCategory->generateTreeList();
		$blogPostTags = $this->BlogPost->BlogPostTag->find('list');
    $today = date('Y-m-d');
		$this->set(compact('blogPostCategories', 'blogPostTags','today'));
      $this->set('page_title','<i class="fa fa-edit"></i> Blog');
      $this->set('page_subtitle','new blog post');
	}
 ...
 */
    ...
    $data = $this->request->data;
		$this->set(compact('blogPostCategories', 'blogPostTags', 'data'));
      $this->set('page_title','<i class="fa fa-edit"></i> Blog');
      $this->set('page_subtitle','edit blog post');
	}
 ...
 */
	public function admin_delete($id = null) {
		...
		if ($this->BlogPost->delete()) {
			$this->Session->setFlash('Blog post deleted','flash-success');
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash('Blog post was not deleted','flash-error');
		$this->redirect(array('action' => 'index'));
	}
}
